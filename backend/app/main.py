...
from app.api import auth, users, children, stories, quizzes, reports, progress, parent_coaching, rankings, coppa_compliance, friends, challenges, purchases
...
app.include_router(purchases.router, prefix=f"{PREFIX}/purchases", tags=["課金"])
